...
font_import(pattern = "xkcd", prompt=FALSE, paths = "C:/Christoph/DataVizPlay/scripts")
fonts()
fonttable()
...
p + stat_compare_means(comparisons = my_comparisons, label = "p.signif", hide.ns = TRUE) + 
...
# Add pairwise comparisons p-value
p + stat_compare_means(comparisons = my_comparisons, label = "p.signif", hide.ns = FALSE)
